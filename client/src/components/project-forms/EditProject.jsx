...
import { getCurrentProjects, updateProject } from '../../actions/project';
      ...
      <section className='contenedor'>
        ...
        >
          <section className='formulario-grid-01'>
            ...
            <div className='grupo'>
              <label htmlFor='semester'>Semestre en el que se realizó:</label>
              <select
                id='semester'
                name='semester'
                value={semester}
          ...
          <section className='formulario-grid-02'>
            ...
            {displayInputs && (
              <section>
                ...
                <div className='grupo'>
                  <label htmlFor='delimitation'>Delimitación del tema:</label>
                  <textarea
                    id='delimitation'
                    type='text'
                ...
                <div className='grupo'>
                  <label htmlFor='impactTechnology'>Impacto técnologico:</label>
                  <textarea
                    id='impactTechnology'
                    type='text'
                ...
                <div className='grupo'>
                  <label htmlFor='degreeInnovation'>Grado de inovación:</label>
                  <textarea
                    type='text'
                ...
                <div className='grupo'>
                  <label htmlFor='innovation'>Innovación del proyecto:</label>
                  <textarea
                    id='innovation'
                    type='text'
                ...
                <div className='grupo'>
                  <label htmlFor='conclusion'>Conclusión del proyecto:</label>
                  <textarea
                    id='conclusion'
                    type='text'
...
export default connect(mapStateToProps, { getCurrentProjects, updateProject })(
